...
import XinFinZCondition from './components/applyxinfin/XinFinZCondition.vue'
import XinFinZApplication from './components/applyxinfin/XinFinZApplication.vue'
import XinFinZConfirm from './components/applyxinfin/XinFinZConfirm.vue'
...
import XinFinXCondition from './components/applyxinfinx/XinFinXCondition.vue'
import XinFinXConfirm from './components/applyxinfinx/XinFinXConfirm.vue'
import './utils/codemirror'

import XRC21IssuerAritfacts from '../build/contracts/XRC21Issuer.json'
import XinFinXListingAritfacts from '../build/contracts/xinfinxListing.json'
...
Vue.prototype.setupProvider = async function (provider, wjs) {
    ...
    // Vue.prototype.XRC21Issuer = contract(XRC21IssuerAritfacts)
    if (wjs instanceof Web3) {
        ...
        if (chainConfig.issuerAddress) {
            Vue.prototype.XRC21Issuer = new wjs.eth.Contract(
                XRC21IssuerAritfacts.abi,
                chainConfig.issuerAddress
            )
        }
        if (chainConfig.XinFinxAddress) {
            Vue.prototype.XinFinXListing = new wjs.eth.Contract(
...
/**
 * @return xinfinValidator contract instance
 */
Vue.prototype.getXRC21IssuerInstance = async function () {
    // workaround for web3 version 1.0.0
    // @link https://github.com/trufflesuite/truffle-contract/issues/57#issuecomment-331300494
    if (typeof Vue.prototype.XRC21Issuer.currentProvider.sendAsync !== 'function') {
        Vue.prototype.XRC21Issuer.currentProvider.sendAsync = function () {
            return Vue.prototype.XRC21Issuer.currentProvider.send.apply(
                Vue.prototype.XRC21Issuer.currentProvider,
                arguments
            )
        }
    }
    let instance = await Vue.prototype.XRC21Issuer.deployed()
    return instance
}
...
const router = new VueRouter({
    ...
    routes: [
        ...
        { path: '/xinfinzcondition/:address', component: XinFinZCondition },
        { path: '/xinfinzapplication/:address', component: XinFinZApplication },
        { path: '/xinfinzconfirm/:address', component: XinFinZConfirm, name: 'XinFinZConfirm' },
        ...
        { path: '/xinfinxcondition/:address', component: XinFinXCondition },
        { path: '/xinfinxconfirm/:address', component: XinFinXConfirm }
    ]
})
