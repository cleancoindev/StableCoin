<template>
    <div class="container container-medium">
        <div class="xdc-apply text-center">
            <h2 class="tmp-title-large">Pay fee by {{ token.name }} token</h2>
            <div class="about-xinfinz">
                <h6 class="tmp-title-normal weightbold">What is XinFInZ</h6>
                <p>
                    XinFInZ - the first on-chain protocol that offers the ability for any user
                    to pay transaction fees with the same token the user is holding. Along with
                    the XinFInZ protocol, XRC21 is also proposed as a new smart contract-based
                    token standard that allows users to pay fees of any transaction sent to a
                    XRC21 smart contract in terms of the XRC21 token itself, without holding XDC in their wallet.
                </p>
            </div>
            <div class="box-condition">
                ...
                <b-row>
                    <b-col
                        ...
                        <p>
                            The token issuer has to deposit a minimum amount of 10 XDC to apply
                            to the XinFInZ protocol. The deposit cannot be withdrawn.
                        </p>
                    </b-col>
                    <b-col
                        cols="6">
                    ...
                    <b-col
                        ...
                        <p>
                            Token transactions will not be processed if the XDC deposit is not
                            enough for paying masternodes. In that case, any one can donate
                            XDC to resume the token transaction processing.
                        </p>
                    </b-col>
                </b-row>
            </div>
