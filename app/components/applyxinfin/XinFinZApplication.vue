    ...
    <div class="container container-small">
        <div class="xdc-apply">
            ...
            <b-form
                ...
                <b-form-group
                    :description="`TX fee: 0.0005 XDC, Available balance: ${balance} XDC`"
                    ...
                    <b-form-input
                        v-model="depositFee"
                        type="text"
                        placeholder="How much XDC do you want to deposit? (Min: 10 XDC)..."
                        @input="onChange"/>
                    <div
                    ...
                    <div
                        ...
                        class="text-danger pt-2">Minimum of depositing is 10 XDC</div>
                    <div
...
export default {
    ...
    methods: {
        ...
        confirm () {
            this.$router.push({ name: 'XinFinZConfirm',
                params: {
