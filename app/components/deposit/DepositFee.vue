    ...
    <div class="container container-small flex-content-center">
        <div class="xdc-body-fullw">
            <div class="info-header">
                <h2 class="tmp-title-large">Deposit XRC-21 fee</h2>
                <p>Current {{ token.name }} fee fund: {{ currentPoolingFee }} XDC</p>
            </div>
            <b-form
                class="tmp-form-one"
                novalidate
                ...
                <b-form-group
                    :description="`TX fee: 0.0005 XDC, Available balance: ${showingBalance} XDC`"
                    ...
                    <b-form-input
                        v-model="depositFee"
                        type="number"
                        placeholder="How much XDC do you want to deposit?..."
                        @input="onChange"/>
                    <div
