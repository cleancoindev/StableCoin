<template>
    <div class="container container-small">
        <div class="newtoken">
            <h2 class="tmp-title-large">StableCoin Issuance</h2>
            <b-form
                ...
                <b-form-group
                    ...
                    <b-form-input
                        ...
                        autocomplete="off"
                        maxlength="20"
                        placeholder="Please use only Latin letters and numbers, e.g. “Tether”"
                        @input="onChangeName"
                        @change="onChangeName"/>
                    <div
                        v-if="checkName"
                        class="txt-fixed-behind">
                        <i class="stablecoin-icon-checkmark-outline custom-checkmark"/>
                    </div>
                    <small
                ...
                <b-form-group
                    ...
                    <b-form-input
                        ...
                        type="text"
                        maxlength="5"
                        placeholder="Please use only Latin letters and numbers, e.g. “USDT”"
                    ...
                    <!-- <small
                        ...
                        Please use only Latin letters and numbers, e.g. “XDC”
                    </small> -->
                    <small
                        class="float-right txt-fixed-description">
                ...
                <b-form-group
                    ...
                    <label>
                        ...
                        <i
                            id="totalSupply"
                            class="stablecoin-icon-info mb-2"/>
                    </label>
                    <b-tooltip
                        target="totalSupply">
                        This field refers to the total amount of StableCoin supply that your asset will contain
                    </b-tooltip>
                ...
                <!-- <div class="form-group flex-box mb-4">
                    <label>Est. Issuance Fee</label><span>{{ txFee }} XDC</span>
                </div> -->
                <div class="btn-box">
                    <b-button
                        class="tmp-btn-blue"
...
export default {
    ...
    methods: {
        ...
        validate: function () {
            this.$v.$touch()
            if (!this.$v.$invalid && this.isEnoughXDC) {
                this.confirm()
            }
        },
        confirm () {
