    ...
    <div class="container container-small">
        <div class="confirm-table">
            ...
            <div class="tmp-table-three">
                <table>
                    ...
                    <tr>
                        ...
                        <td>{{ formatNumber(donationAmount) }} XDC</td>
                    </tr>
                    <tr>
            ...
            <div class="qr-code-donate text-center d-none">
                <p>
                    <b-img
                        src="/app/assets/images/img-qrcode-xdcwallet.png"
                        alt="img-qrcode-xdcwallet.png"/>
                </p>
                <p>
                    <b>Scan QR code below using xdcwallet to donate</b>
                </p>
            </div>
            <div class="btn-box">
                <b-button
            ...
            <b-modal
                ...
                <div class="xdc-modal-default">
                    <div class="msg-txt">
                        ...
                        <h4>Successful</h4>
                        <p>You’ve succesfully donated {{ donationAmount }} XDC</p>
                        <p>
                            Transaction hash:
                            <a
