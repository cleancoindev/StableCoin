<template>
    <div class="container container-small">
        <div class="xdc-donate">
            <h2 class="tmp-title-large">Donate XRC-21 transaction fee</h2>
            <div class="box-desc">
                <h6 class="tmp-title-normal weightbold">Why do we need to donate XRC-21 transaction fee?</h6>
                <p>
                    ...
                    of token transactions, any XDC holder can deposit/donate XDC to the StableCoin smart contract.
                </p>
            </div>
            <b-form
                class="tmp-form-one"
                ...
                <b-form-group
                    ...
                    <div
                        ...
                        <div>
                            Contract address:
                            <b-link
                                :href="config.xinfinscanUrl + '/tokens/' + tokenAddress"
                                target="_blank">
                                {{ tokenAddress }}
                            </b-link>
                        </div>
                        <div>
                            XRC-21 fee fund: {{ formatNumber(poolingFee) }} XDC
                        </div>
                    </div>
                    <div
                        v-if="!tokenExist"
                ...
                <b-form-group
                    ...
                    <div
                        ...
                        class="text-danger pt-2">Deposit amount should be more than 0 XDC</div>
                    <div
                        v-else-if="depositingError"
                        class="text-danger pt-2">Not enough XDC</div>
                </b-form-group>
                <div class="btn-box">
                    <b-button
                        class="tmp-btn-blue"
