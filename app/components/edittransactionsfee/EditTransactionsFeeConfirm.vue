<template>
    <div class="container container-small flex-content-center">
        <div class="confirm-table xdc-body-fullw">
            ...
            <div class="qr-code-donate text-center d-none">
                ...
                <p>
                    <b>Scan QR code below using xdcwallet to edit</b>
                </p>
            </div>
            <div class="btn-box">
                <b-button
        ...
        async changeTXFee () {
            try {
                if (this.newFee) {
                    ...
                    if (!data.abi) {
                        this.loading = false
                        this.$toasted.show('This contract is not verified. Please go to XinFinScan to verify contract')
                    } else {
