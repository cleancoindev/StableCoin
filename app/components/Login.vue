<template>
    <div
                ...
                <b-form
                    ...
                    <b-tabs v-model="tabIndex">
                        <b-tab>
                            ...
                            <b-link
                                href="https://howto.xinfin.org/xinfinpay/features/">
                                How to Access XinPay?
                            </b-link>
        ...
        <b-modal
            ...
            hide-header
            hide-footer>
            <div class="xdc-modal-default text-left">
...
export default {
    ...
    methods: {
        ...
        validate: function () {
            ...
            if ((tabIndex === 1 || tabIndex === 2) && !this.$v.mnemonic.$invalid) {
        ...
        loginWallet () {
            if (this.mobileCheck) {
                window.open('xdposchain://dapp?url=https://issuer.testnet.xinfin.network')
            } else {
                if (confirm('Download xdcwallet to open in app')) {
                    window.open('https://play.google.com/store/apps/details?id=com.xdposchain.wallet&hl=en')
                }
            }
        }
    }
